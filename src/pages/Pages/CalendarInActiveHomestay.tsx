...
const CalendarInActiveHomestay = () => {
    ...
    useEffect(() => {
        const fetchBookingCalendar = async () => {
            try {
                ...
                const response = await homestayAPI.getListEventInactiveHomestay(params);
        ...
        if (homestayId && startDate && endDate && isSubmit === false) {
            fetchBookingCalendar();
        }
    }, [homestayId, startDate, endDate, isSubmit]);
    ...
    const saveEvent = async () => {
        ...
        try {
            setIsSubmit(true);
            if(isCreate){
                const response: any = await homestayAPI.updateStatusV2([
                    {
                        homeStayId: homestayId,
                ...
                const response: any = await homestayAPI.activeHomestayByOwner(
                    {
                        homeStayId: homestayId,
                        startDate: params?.start,
                        endDate: params?.end,
...
export default CalendarInActiveHomestay;
