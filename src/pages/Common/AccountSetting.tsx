...
const AccountSetting = () => {
    ...
    const [avatar, setAvatar] = useState('/assets/images/profile-35.jpg'); // Initial avatar image
    const [newAvatar, setNewAvatar] = useState<any>(null); // State to store the newly selected avatar file
    ...
    const handleUpdateAvatar = () => {
        console.log('Hình Submit nè !!!', 'abc');
    };
                            ...
                            <div className="flex flex-col sm:flex-row">
                                <div className="mb-5 w-full sm:w-2/12 ltr:sm:mr-4 rtl:sm:ml-4">
                                    <div className="relative">
                                        <img
                                            src={require('path/to/your/image.jpg')}
                                            alt="Young man drawing his index finger across his forehead"
                                            className="h-64 w-64 rounded-full object-cover"
                                        />
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            <div className="h-1 w-1/2 rounded-full bg-blue-500"></div>
                                        </div>
                                    </div>
                                    <input
                                        type="file"
                            ...
                            <div className="panel">
                                <div className="mb-5">
                                    ...
                                    <p>
                                        ...
                                        information will take effect starting
                                        with scheduled payment and will be
                        ...
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                            <div className="panel space-y-5">
                                ...
                                <p>
                                    ...
                                    will be visible to anyone on the network.
                                </p>
                            ...
                            <div className="panel space-y-5">
                                ...
                                <p>
                                    Display{' '}
                                    <span className="text-primary">Ads</span> on
                                    your dashboard
                                </p>
                                <label className="relative h-6 w-12">
                                    <input
                    ...
                    <div className="switch">
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                            <div className="panel space-y-5">
                                ...
                                <p>
                                    Remove the active resource from the cache
                                    without waiting for the predetermined cache
                                    expiry time.
                                </p>
