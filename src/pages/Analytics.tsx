            ...
            <div className="pt-5">
                <div className="mb-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div
                        ...
                        style={{
                            background:
                                'linear-gradient(0deg,#00c6fb -227%,#005bea)',
                        }}
                    >
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="w-full flex-initial px-3">
                                    <div className="w-summary-info mb-1 flex justify-between font-semibold text-white-dark">
                                        <h6>Chrome</h6>
                                        <p className="text-xs ltr:ml-auto rtl:mr-auto">
                                            65%
                                        </p>
                                    </div>
                                    <div>
                    ...
                    <div className="panel h-full p-0">
                        <div className="flex p-5">
                            ...
                            <div className="font-semibold ltr:ml-3 rtl:mr-3">
                                ...
                                <h5 className="text-xs text-[#506690]">
                                    Followers
                                </h5>
                            </div>
                        </div>
                        ...
                        <div className="group">
                            ...
                            <div className="mb-2 flex items-center justify-between font-semibold">
                                <div className="flex items-center">
                                    ...
                                    <div className="text-xs ltr:ml-2 rtl:mr-2">
                                        5 Tasks
                                    </div>
                                </div>
