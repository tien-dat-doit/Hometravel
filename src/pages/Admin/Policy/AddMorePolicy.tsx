...
export default function AddMorePolicy({ modal17, setModal17, policyTitle3 }: any) {
    ...
    const addBlock = () => {
        ...
        setFormData(prevState => ({
            ...
            amenitieData: [
                ...
                { id: '', description: '', subDescription: 'ACTIVE', policyTitleId:''},
            ],
        }));
    };
    const resetData = () => {
    ...
    const addAmenity = async (amenitieData: any) => {
        try {
            const promises = amenitieData.map((amenity : any)=> policyAPI.postPolicies(amenity));
