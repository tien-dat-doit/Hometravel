...
const TableUsers: React.FC<UserTypes> = ({ rowData, setIsUpdate }) =>  {
    ...
    return (
        ...
        <DataTable
            ...
            records={recordsData}
            noRecordsText="Không có người dùng"
            columns={[
                {
                    accessor: 'STT',
                    title: 'STT',
                    ...
                    render: ({ firstName, lastName, avatar,id,type }) => (
                        <div className="flex w-max items-center">
                            <div className="flex items-center w-max">
                                <img src={avatar !== null ? avatar : './assets/images/no-image.jpg'} alt="Avatar" className="w-9 h-9 rounded-full ltr:mr-2 rtl:ml-2 object-cover" />
